...
import { IconSun, IconMoon, IconBrandLaravel, IconSettings, IconBrandJustd, IconColorSwatch, IconChevronDown } from "justd-icons";
...
function UserMenu() {
  ...
  return /* @__PURE__ */ jsxs(Menu, { children: [
    ...
    /* @__PURE__ */ jsxs(Menu.Content, { showArrow: true, placement: "bottom end", className: "sm:min-w-56", children: [
      ...
      /* @__PURE__ */ jsx(Menu.Separator, {}),
      /* @__PURE__ */ jsxs(Menu.Item, { target: "_blank", href: "https://laravel.com", className: "justify-between", children: [
        "Documentation",
        /* @__PURE__ */ jsx(IconBrandLaravel, {})
      ] }),
      /* @__PURE__ */ jsxs(Menu.Item, { target: "_blank", href: "https://getjustd.com", className: "justify-between", children: [
        "Components",
        /* @__PURE__ */ jsx(IconBrandJustd, {})
      ] }),
      /* @__PURE__ */ jsxs(Menu.Item, { target: "_blank", href: "https://getjustd.com/colors", className: "justify-between", children: [
        "Colors",
        /* @__PURE__ */ jsx(IconColorSwatch, {})
      ] }),
      /* @__PURE__ */ jsx(Menu.Separator, {}),
