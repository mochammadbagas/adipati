...
function Edit({ product }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Header, { title: "Edit Product" }),
    /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
      /* @__PURE__ */ jsxs(Card.Header, { children: [
        ...
        /* @__PURE__ */ jsx(Card.Description, { children: "Create compelling products that inspire, inform, and engage—it's quick, simple, and impactful. Start now!" })
      ] }),
