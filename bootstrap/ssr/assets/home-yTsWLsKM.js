...
function handleDelete(slug) {
  if (confirm("Are you sure you want to delete this item?")) {
    router.visit(route("product.destroy", slug), {
      method: "delete",
...
function Home(props) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Container, { children: [
      /* @__PURE__ */ jsx(Button, { className: "mb-12", children: /* @__PURE__ */ jsx(Link, { href: route("product.create"), children: "Add New Product" }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Table, { "aria-label": "Products", children: [
        ...
        /* @__PURE__ */ jsx(Table.Body, { items: products, children: (item) => /* @__PURE__ */ jsxs(Table.Row, { id: item.id, children: [
          ...
          /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs(Menu, { children: [
            ...
            /* @__PURE__ */ jsxs(Menu.Content, { "aria-label": "Actions", showArrow: true, placement: "left", children: [
              /* @__PURE__ */ jsx(Menu.Item, { href: route("product.show", item.slug), children: "View" }),
              /* @__PURE__ */ jsx(Menu.Item, { href: route("product.edit", item.slug), children: "Edit" }),
