...
import { u as useTheme, f as buttonStyles, i as Loader } from "./tooltip-Cbn6jex2.js";
import { IconTriangleInfoFill, IconCheck, IconCircleInfoFill } from "justd-icons";
  ...
  return /* @__PURE__ */ jsx(
    Toaster,
    {
      ...
      icons: {
        ...
        warning: /* @__PURE__ */ jsx(IconTriangleInfoFill, {}),
        error: /* @__PURE__ */ jsx(IconTriangleInfoFill, {}),
        loading: /* @__PURE__ */ jsx(Loader, { variant: "spin" })
      },
      toastOptions: {
        unstyled: true,
        closeButton: true,
        classNames: {
          ...
          warning: "bg-warning text-warning-fg ring-warning-fg/10 ring-inset [&>[data-close-button=true]>svg]:text-amber-950",
          success: "bg-primary ring-primary/50 text-primary-fg ring-inset [&>[data-close-button=true]>svg]:text-primary-fg",
