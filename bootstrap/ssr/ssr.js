...
const Ziggy$1 = { "url": "https://homespaces.my.id", "port": null, "defaults": {}, "routes": { "sanctum.csrf-cookie": { "uri": "sanctum/csrf-cookie", "methods": ["GET", "HEAD"] }, "home": { "uri": "/", "methods": ["GET", "HEAD"] }, "about": { "uri": "about", "methods": ["GET", "HEAD"] }, "article": { "uri": "article", "methods": ["GET", "HEAD"] }, "article.show": { "uri": "article/{article}", "methods": ["GET", "HEAD"], "parameters": ["article"], "bindings": { "article": "slug" } }, "article.table": { "uri": "dashboard/article", "methods": ["GET", "HEAD"] }, "article.create": { "uri": "dashboard/article/create", "methods": ["GET", "HEAD"] }, "article.store": { "uri": "dashboard/article/create", "methods": ["POST"] }, "article.edit": { "uri": "dashboard/article/{article}/edit", "methods": ["GET", "HEAD"], "parameters": ["article"], "bindings": { "article": "slug" } }, "article.update": { "uri": "dashboard/article/{article}", "methods": ["PATCH"], "parameters": ["article"], "bindings": { "article": "slug" } }, "article.destroy": { "uri": "dashboard/article/{article}", "methods": ["DELETE"], "parameters": ["article"], "bindings": { "article": "slug" } }, "article.category": { "uri": "article/category/{category}", "methods": ["GET", "HEAD"], "parameters": ["category"], "bindings": { "category": "slug" } }, "product": { "uri": "product", "methods": ["GET", "HEAD"] }, "product.show": { "uri": "product/{product}", "methods": ["GET", "HEAD"], "parameters": ["product"], "bindings": { "product": "slug" } }, "product.table": { "uri": "dashboard/product", "methods": ["GET", "HEAD"] }, "product.create": { "uri": "dashboard/product/create", "methods": ["GET", "HEAD"] }, "product.store": { "uri": "dashboard/product/create", "methods": ["POST"] }, "product.edit": { "uri": "dashboard/product/{product}/edit", "methods": ["GET", "HEAD"], "parameters": ["product"], "bindings": { "product": "slug" } }, "product.update": { "uri": "dashboard/product/{product}", "methods": ["PATCH"], "parameters": ["product"], "bindings": { "product": "slug" } }, "product.destroy": { "uri": "dashboard/product/{product}", "methods": ["DELETE"], "parameters": ["product"], "bindings": { "product": "slug" } }, "product.category": { "uri": "product/category/{category}", "methods": ["GET", "HEAD"], "parameters": ["category"], "bindings": { "category": "slug" } }, "dashboard": { "uri": "dashboard", "methods": ["GET", "HEAD"] }, "profile.edit": { "uri": "profile", "methods": ["GET", "HEAD"] }, "profile.update": { "uri": "profile", "methods": ["PATCH"] }, "profile.destroy": { "uri": "profile", "methods": ["DELETE"] }, "register": { "uri": "register", "methods": ["GET", "HEAD"] }, "login": { "uri": "login", "methods": ["GET", "HEAD"] }, "password.request": { "uri": "forgot-password", "methods": ["GET", "HEAD"] }, "password.email": { "uri": "forgot-password", "methods": ["POST"] }, "password.reset": { "uri": "reset-password/{token}", "methods": ["GET", "HEAD"], "parameters": ["token"] }, "password.store": { "uri": "reset-password", "methods": ["POST"] }, "verification.notice": { "uri": "verify-email", "methods": ["GET", "HEAD"] }, "verification.verify": { "uri": "verify-email/{id}/{hash}", "methods": ["GET", "HEAD"], "parameters": ["id", "hash"] }, "verification.send": { "uri": "email/verification-notification", "methods": ["POST"] }, "password.confirm": { "uri": "confirm-password", "methods": ["GET", "HEAD"] }, "password.update": { "uri": "password", "methods": ["PUT"] }, "logout": { "uri": "logout", "methods": ["POST"] } } };
...
const appName = "Adipati";
createServer(
  (page) => createInertiaApp({
    page,
    render: ReactDOMServer.renderToString,
    title: (title) => title ? `${title} / ${appName}` : appName,
    resolve: (name) => resolvePageComponent(`./pages/${name}.tsx`, /* @__PURE__ */ Object.assign({ "./pages/about.tsx": () => import("./assets/about-KM4WHjU6.js"), "./pages/article/category.tsx": () => import("./assets/category-DdbAzDa4.js"), "./pages/article/dashboard/create.tsx": () => import("./assets/create-DQrmIfRA.js"), "./pages/article/dashboard/edit.tsx": () => import("./assets/edit-Cwif1Sz6.js"), "./pages/article/dashboard/home.tsx": () => import("./assets/home-BcpWrkxn.js"), "./pages/article/home.tsx": () => import("./assets/home-D4La3WgY.js"), "./pages/article/show.tsx": () => import("./assets/show-DYTIg2lI.js"), "./pages/auth/confirm-password.tsx": () => import("./assets/confirm-password-aFe3iCPK.js"), "./pages/auth/forgot-password.tsx": () => import("./assets/forgot-password-B5FkbcML.js"), "./pages/auth/login.tsx": () => import("./assets/login-bDbyfFxY.js"), "./pages/auth/register.tsx": () => import("./assets/register-JMG8N_hN.js"), "./pages/auth/reset-password.tsx": () => import("./assets/reset-password-IK-aMs7O.js"), "./pages/auth/verify-email.tsx": () => import("./assets/verify-email-D1YowxgS.js"), "./pages/dashboard.tsx": () => import("./assets/dashboard-Dp_JBuwf.js"), "./pages/home.tsx": () => import("./assets/home-B2uOwStw.js"), "./pages/product/category.tsx": () => import("./assets/category-CLlxv-KX.js"), "./pages/product/dashboard/create.tsx": () => import("./assets/create-DzTCgFmD.js"), "./pages/product/dashboard/edit.tsx": () => import("./assets/edit-sVHzjaW6.js"), "./pages/product/dashboard/home.tsx": () => import("./assets/home-yTsWLsKM.js"), "./pages/product/home.tsx": () => import("./assets/home-CnjLLlzV.js"), "./pages/product/show.tsx": () => import("./assets/show-D-WrP0NT.js"), "./pages/profile/edit.tsx": () => import("./assets/edit-Dt7StkL_.js"), "./pages/profile/partials/delete-user-form.tsx": () => import("./assets/delete-user-form-DTmGJbE4.js"), "./pages/profile/partials/update-password-form.tsx": () => import("./assets/update-password-form-PenBPB-9.js"), "./pages/profile/partials/update-profile-information-form.tsx": () => import("./assets/update-profile-information-form-BJfSEXuf.js") })),
    setup: ({ App, props }) => {
