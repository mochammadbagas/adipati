        ...
        <>
            ...
            <Container>
                <Button className="mb-12">
                    <Link href={route('product.create')}>Add New Product</Link>
                </Button>
                <Card>
                                        ...
                                        <div className="flex justify-end">
                                            <Menu>
                                                ...
                                                <Menu.Content aria-label="Actions" showArrow placement="left">
                                                    <Menu.Item href={route('product.show', item.slug)}>View</Menu.Item>
                                                    <Menu.Item href={route('product.edit', item.slug)}>Edit</Menu.Item>
                                                    <Menu.Separator />
